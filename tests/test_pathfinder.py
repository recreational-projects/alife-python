...
@pytest.fixture
def pathfinder(monkeypatch: pytest.MonkeyPatch) -> Pathfinder:
...
def test_create_path(monkeypatch: pytest.MonkeyPatch, pathfinder: Pathfinder) -> None:
...
def test_create_simple_path(pathfinder: Pathfinder) -> None:
...
def test_create_astar_path(pathfinder: Pathfinder) -> None:
...
def test_create_8way_astar_path(pathfinder: Pathfinder) -> None:
...
def test_create_hpa_path(pathfinder: Pathfinder) -> None:
