...
class Task:
    ...
    def award_exp(self, squad: Squad) -> None:
...
class CombatTask(Task):
    ...
    async def _run(self, grid: MapGrid, left: Squad, right: Squad) -> None:
...
class TradeTask(Task):
    ...
    async def _run(self, grid: MapGrid, squad: Squad) -> None:
        squad.has_task = True
...
class IdleTask(Task):
    ...
    async def _run(self, grid: MapGrid, squad: Squad, duration: int) -> None:
